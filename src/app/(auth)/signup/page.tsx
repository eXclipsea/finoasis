    ...
    <div className="min-h-screen bg-gradient-to-b from-[#E8F4F8] to-[#D4E9F0] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-[#B8D4E3] p-8 relative z-10">
        ...
        <div className="flex flex-col items-center mb-8 pt-8">
          <div className="bg-[#E8A87C] p-4 rounded-3xl shadow-lg mb-4">
            <Sparkles className="h-10 w-10 text-white" />
          </div>
          <h1 className="text-3xl font-black text-[#2D5A4A] tracking-tight">Create Your Home</h1>
          <p className="text-[#5A8A7A] font-medium mt-2">Join BudgetFriend for free</p>
        </div>
        ...
        <form className="flex flex-col gap-4" action={signUp}>
          ...
          <button className="mt-4 w-full bg-[#E8A87C] text-white font-bold py-4 rounded-xl shadow-lg shadow-[#E8A87C]/20 hover:bg-[#D9976B] hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2">
            Create Account
          </button>
          
          {message && (
            <div className={`p-4 rounded-xl text-sm font-medium text-center border-2 ${
              message.includes('Check email') 
                ? 'bg-[#7EB8A2]/10 text-[#7EB8A2] border-[#7EB8A2]' 
          ...
          <div className="text-center mt-6 text-[#5A8A7A] font-medium">
            ...
            <Link href="/login" className="text-[#7EB8A2] hover:text-[#6BA08A] font-bold hover:underline">
              Log in
            </Link>
          </div>
