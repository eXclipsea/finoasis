  ...
  return (
    <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2 mx-auto min-h-screen">
      ...
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="text-2xl font-bold text-center">Start Your Oasis Free</h1>
        <p className="text-slate-500 text-sm mt-2 text-center">Join FinOasis today</p>
      </div>
      ...
      <form className="animate-in flex-1 flex flex-col w-full justify-center gap-2 text-foreground" action={signUp}>
        ...
        {message && (
          <p className={`mt-4 p-4 rounded-md text-sm text-center ${
